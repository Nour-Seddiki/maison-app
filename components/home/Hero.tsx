...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-12 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-0 items-center min-h-[80vh]">
          ...
          <div className="z-10 animate-fade-in">
            <p className="label-caps text-text-muted mb-6">Private Residences & Advisory</p>
            <h1 className="font-heading text-5xl md:text-7xl lg:text-8xl font-light text-text-primary leading-[0.95] mb-8">
              Find Your
              <br />
              <span className="italic text-gold">Perfect Home</span>
            </h1>
            <p className="text-text-secondary font-body font-light text-sm md:text-base leading-relaxed tracking-wider max-w-md mb-10">
            ...
            <div className="flex items-center gap-10 md:gap-16">
              {stats.map((stat, i) => (
                <div key={i} className="text-center">
                  <p className="font-heading text-3xl md:text-4xl text-text-primary">{stat.number}</p>
      ...
      {/* Filter Bar */}
      <div className="absolute bottom-12 left-0 right-0 px-6 md:px-12 animate-slide-up" style={{ animationDelay: '500ms' }}>
        <div className="max-w-[1400px] mx-auto">
          <div className="bg-surface/80 backdrop-blur-md border border-border p-4 md:p-6 flex flex-wrap items-end gap-4">
